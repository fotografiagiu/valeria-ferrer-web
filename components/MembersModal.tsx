    ...
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-6 bg-black/80 backdrop-blur-md">
      <div className="relative bg-[#111111] border border-[#c2b2a3]/20 w-full max-w-2xl p-10 md:p-16 text-center animate-in fade-in zoom-in duration-300">
        <button
          ...
          aria-label="Cerrar ventana de miembros"
        >
        ...
        <div className="py-12 border border-white/5 bg-[#1a1a1a]/50 rounded-xl mb-8">
          ...
          <p className="text-[10px] text-gray-400 mt-4 uppercase tracking-widest">Estamos preparando un espacio exclusivo para nuestros clientes más selectos.</p>
        </div>

        <div className="mt-12 pt-10 border-t border-white/5">
          <p className="text-[10px] text-gray-400 tracking-[0.2em] leading-relaxed uppercase">
